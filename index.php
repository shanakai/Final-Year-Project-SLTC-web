...
<meta http-equiv="Expires" content="0" />
  <!-- Favicons -->
  <link href="assets/img/vis-logo.png" rel="icon">
  <link href="assets/img/vis-logo.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div id="logo">
        <a href="index.php"><img src="assets/img/vis-logo.png" width="20%" alt=""></a>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Vehicle Identification System</strong>. All Rights Reserved
      </div>
      <div class="credits">
