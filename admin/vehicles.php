    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php">Registerd Drivers</a></li>
        </ul>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><b>Registerd Vehicles</b></h2>
          <ol>
            <li><a href="index.html">Admin Home</a></li>
            <li>Registerd Vehicles</li>
          </ol>
        </div>
...
<br><br><br>
 ...
 <table class="table">
  ...
  foreach ($resultArray as $row) {
    ...
    <td><?php echo $row['ownerNic']; ?> </td>
    <td><?php echo $row['chacyNumber']; ?> </td>
      <td><?php echo $row['vehicleNumber']; ?> </td>
      <td><?php echo $row['vehicleType']; ?> </td>
      <td><?php echo '<a class="btn btn-danger" href="../services/vehicle_delete.php?vid='.$row['id'].'">Delete</a>';?></td>
    </tr>
    <?php }
             ?>
  </tbody>
